...
/**
 * get_av_with_flags_helper - helper function for gettting argument eith flags.
 * @token: The token.
 * @line: The input line.
 ...
 * @name: the name of the env varaible.
 * Return: the value of the nenv var, or NULL if not found.
 */
...
/**
 * char_count - count occurances of a character in a string.
 * @str: the input string.
 * @c: the charactyer to count.
